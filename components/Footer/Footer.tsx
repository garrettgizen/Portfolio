  ...
  return (
    <footer className="bg-footerBackground text-footerForeground">
      <div className="flex flex-col container px-0! border-footerBorder border-x">
        <div className="grid grid-cols-1 divide-y border-b border-footerBorder divide-footerBorder tablet:grid-cols-2 tablet:divide-y-0 tablet:divide-x *:py-20 *:px-4 *:tablet:first:pr-12 *:tablet:last:pl-12">
